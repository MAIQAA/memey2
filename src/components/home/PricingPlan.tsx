...
const PricingSection: React.FC = () => {
  return (
    <section className="relative bg-gradient-to-b from-gray-50 to-white py-6 md:py-10">
      <div className="flex flex-col items-center w-full max-w-7xl mx-auto py-8 md:py-10 lg:py-[3.35rem] px-4 xl:px-0">
        {/* Header Section */}
        ...
        <div className="w-full max-w-3xl grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8 items-stretch self-center">
